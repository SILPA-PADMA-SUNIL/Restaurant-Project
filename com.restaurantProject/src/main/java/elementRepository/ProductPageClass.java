...
public class ProductPageClass {
	...
	public String addProduct() throws InterruptedException, IOException
	{
		...
		enterProductTax(readProductTax(4, 1));
		enterProductPrice(readProductPrice(5, 1));
		clickOnFirstSubmitBtnOnAddProduct();
		clickOnSecondSubmitBtnOnAddProduct();
		refreshTheProductPage();
		return code;
	}
}
